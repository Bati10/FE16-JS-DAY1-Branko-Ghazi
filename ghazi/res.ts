var menu:{meal:string,info:string,img:string,price:number,star:string}={meal:'kebab',info:'Kebab is a cooked meat dish, with its origins in Middle Eastern cuisines. Many variants are popular around the world.Kebabs consist of cut up or ground meat, sometimes with vegetables, and various other accompaniments according to the specific recipe',img:'https://i.pinimg.com/originals/9d/e0/7f/9de07fde15b54f8a71dec8d8dbdff0a0.jpg',price:100,star:"&#11088;"};
...
(document.querySelector(".container")as HTMLElement).innerHTML=`   <div class="card mb-3" >
<div class="row g-0">
  <div class="col-md-6">
